...
static handleThoury(level)
{
    ...
    static headerThoury()
    {
        ...
        if (this.level === 40) 
          return this.translate.translate(`<h1 style="text-align: center; color: #333; font-size: 2.5em; margin-bottom: 20px; border-bottom: 2px solid #4CAF50; padding-bottom: 10px;">Present perfect or Past simple</h1>`);       
        if (this.level === 42) 
          return this.translate.translate(`<h1 style="text-align: center; color: #333; font-size: 2.5em; margin-bottom: 20px; border-bottom: 2px solid #4CAF50; padding-bottom: 10px;">Present simple passive, past simple passive</h1>`);    
    ...
    static bodyThoury()
    {
      ...
      if (this.level === 40) 
        return this.translate.translate(`<div class="accordion" id="grammarAccordion">
