const wasOrWere = [
  ...
  [
    ...
    "The instructions were clear not.",
  ...
  ["... he happy?", "was", "were", "", "", "Он был счастлив?", "Ти був щасливий?", "Ty był szczęśliwy?"],
  ["... your friends here?", "were", "was", "", "", "Твои друзья были здесь?", "Твої друзі були тут?", "Twoi przyjaciele byli tutaj?"],
  ["... he at the party last night?", "was", "were", "", "", "Он был на вечеринке прошлой ночью?", "Ти був на вечірці минулої ночі?", "Ty byłeś na imprezie zeszłej nocy?"],
  ["... you ready to go?", "were", "was", "", "", "Вы были готовы идти?", "Ви були готові йти?", "Byliście gotowi, aby iść?"],
  ["... he interested in the topic?", "was", "were", "", "", "Он был заинтересован в теме?", "Ти був зацікавлений у темі?", "Byłeś zainteresowany tematem?"],
  ["... you in the library yesterday?", "were", "was", "", "", "Вы были в библиотеке вчера?", "Ви були в бібліотеці вчора?", "Byliście w bibliotece wczoraj?"],
  ["... she surprised by the news?", "was", "were", "", "", "Она был удивлён новостями?", "Ти був здивований новинами?", "Ty byłeś zaskoczony wiadomościami?"],
  ["... you at school last week?", "were", "was", "", "", "Вы были в школе на прошлой неделе?", "Ви були в школі на минулому тижні?", "Byliście w szkole w zeszłym tygodniu?"],
  ["... you happy with your results?", "were", "was", "", "", "Ты был доволен своими результатами?", "Ти був задоволений своїми результатами?", "Ty byłeś zadowolony ze swoich wyników?"],
  ["... he able to help?", "were", "was", "", "", "Он смог помочь?", "Ти зміг допомогти?", "Ty byłeś w stanie pomóc?"],
  ["... she at the concert last week?", "was", "were", "", "", "Она был на концерте на прошлой неделе?", "Ти був на концерті минулого тижня?", "Ty byłeś na koncercie w zeszłym tygodniu?"],
  ["... they in the office yesterday?", "were", "was", "", "", "Они были в офисе вчера?", "Ви були в офісі вчора?", "Byliście w biurze wczoraj?"],
  ["... he happy with the outcome?", "was", "were", "", "", "Он был доволен результатом?", "Ти був задоволений результатом?", "Ty byłeś zadowolony z wyniku?"],
  ["... you excited about the trip?", "were", "was", "", "", "Вы были в восторге от поездки?", "Ви були в захваті від поїздки?", "Byliście podekscytowani wyjazdem?"],
  ["... you ready for the challenge?", "was", "were", "", "", "Ты был готов к испытанию?", "Ти був готовий до випробування?", "Ty byłeś gotowy na wyzwanie?"],
  ["... you afraid of the storm?", "were", "was", "", "", "Ты боялся шторма?", "Ти боявся шторму?", "Ty bałeś się burzy?"],
  ["... you satisfied with your work?", "were", "was", "", "", "Вы были довольны своей работой?", "Ви були задоволені своєю роботою?", "Byliście zadowoleni z swojej pracy?"],
  ["... you invited to the party?", "were", "was", "", "", "Ты был приглашен на вечеринку?", "Ти був запрошений на вечірку?", "Ty byłeś zaproszony na imprezę?"],
  ["... you at home last weekend?", "were", "was", "", "", "Вы были дома на прошлых выходных?", "Ви були вдома на минулих вихідних?", "Byliście w domu w zeszły weekend?"],
  ["... he busy with your studies?", "was", "were", "", "", "Он был занят учёбой?", "Ти був зайнятий навчанням?", "Ty byłeś zajęty nauką?"],
  ...
  ["... you able to attend the wedding?", "were", "was", "", "", "Ты смог прийти на свадьбу?", "Ти зміг прийти на весілля?", "Ty byłeś w stanie przyjść na wesele?"],
  ["... she aware of the changes?", "was", "were", "", "", "Она была в курсе изменений?", "Ти був у курсі змін?", "Ty byłeś świadomy zmian?"],
  ...
  ["... you on vacation last month?", "were", "was", "", "", "Ты был в отпуске в прошлом месяце?", "Ти був у відпустці минулого місяця?", "Ty byłeś na wakacjach w zeszłym miesiącu?"],
  ["... you close to your siblings?", "were", "was", "", "", "Вы были близки со своими братьями и сестрами?", "Ви були близькі зі своїми братами і сестрами?", "Byliście blisko ze swoimi rodzeństwem?"],
  ["... he excited about the new job?", "was", "were", "", "", "Он был взволнован новой работой?", "Ти був схвильований новою роботою?", "Ty byłeś podekscytowany nową pracą?"],
  ["... you prepared for the exam?", "were", "was", "", "", "Вы были готовы к экзамену?", "Ви були готові до іспиту?", "Byliście gotowi na egzamin?"],
  ["... you pleased with your performance?", "were", "was", "", "", "Ты был доволен своей игрой?", "Ти був задоволений своєю грою?", "Ty byłeś zadowolony ze swojej wydajności?"],
  ["... she worried about the test?", "was", "were", "", "", "Она волновалась по поводу теста?", "Ти хвилювався з приводу тесту?", "Ty martwiłeś się o test?"],
  ["... you excited for the holidays?", "were", "was", "", "", "Вы были рады праздникам?", "Ви були раді святам?", "Byliście podekscytowani wakacjami?"],
  ["... you happy to help?", "were", "was", "", "", "Ты был рад помочь?", "Ти був радий допомогти?", "Ty byłeś szczęśliwy, że mogłem pomóc?"],
  ["... you on the same page?", "were", "was", "", "", "Вы были на одной волне?", "Ви були на одній хвилі?", "Byliście na tej samej stronie?"],
  
  ["... you at the festival last year?", "were", "was", "", "", "Ты был на фестивале в прошлом году?", "Ти був на фестивалі в минулому році?", "Ty byłeś na festiwalu w zeszłym roku?"],
  ["... he surprised by the announcement?", "was", "were", "", "", "Он был удивлён объявлением?", "Ти був здивований оголошенням?", "Ty byłeś zaskoczony ogłoszeniem?"],
  ...
  ["... these your goals last year?", "were", "was", "", "", "Это были твои цели в прошлом году?", "Це були твої цілі минулого року?", "To były twoje cele w zeszłym roku?"],
  ["... you involved in any clubs?", "were", "was", "", "", "Ты был вовлечен в какие-либо клубы?", "Ти був залучений у якісь клуби?", "Byłeś zaangażowany w jakieś kluby?"],
  ["... you on the team last season?", "were", "was", "", "", "Вы были в команде в прошлом сезоне?", "Ви були в команді в минулому сезоні?", "Byliście w drużynie w zeszłym sezonie?"],
  ["... she part of the project?", "was", "were", "", "", "Ты была частью проекта?", "Ти був частиною проекту?", "Ty byłeś częścią projektu?"],
  ["... you able to find a solution?", "were", "was", "", "", "Вы смогли найти решение?", "Ви змогли знайти рішення?", "Byliście w stanie znaleźć rozwiązanie?"],
  ["... he enthusiastic about the changes?", "was", "were", "", "", "Он был восторжен изменениями?", "Ти був захоплений змінами?", "Ty byłeś entuzjastyczny co do zmian?"],
  ["... you confident in your abilities?", "were", "was", "", "", "Вы были уверены в своих способностях?", "Ви були впевнені у своїх здібностях?", "Byliście pewni swoich zdolności?"],
