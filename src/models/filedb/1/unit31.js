...
[
 ...
 ['Is it allowed to park here?', 'You mustn’t park here.', 'You must park here.', 'You don’t need to park here.', 'You need not park here.', 'Здесь разрешено парковаться?', 'Тут дозволено паркуватися?', 'Czy wolno tu parkować?'],
  ...
  ['Is it allowed to enter the water?', 'You mustn’t enter the water.', 'You must enter the water.', 'You don’t need to enter the water.', 'You need not enter the water.', 'Можно заходить в воду?', 'Можна заходити у воду?', 'Czy można wejść do wody?'],
...
['Do I need to wear a helmet while cycling?', 'No, you don’t need to wear a helmet while cycling.', 'Yes, you must wear a helmet while cycling.', 'You mustn’t wear a helmet while cycling.', 'Yes, you have to wear a helmet while cycling.', 'Мне нужно носить шлем при езде на велосипеде?', 'Мені не потрібно носити шолом під час їзди на велосипеді?', 'Czy muszę nosić kask podczas jazdy na rowerze?'],
