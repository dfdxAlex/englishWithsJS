...
export const forSinceAgoPrPerfPastSimple = [
    ...
    ["They have studied English ... three years.", "for", "since", "ago", "lately", "Они учат английский три года.", "Вони вивчають англійську вже три роки.", "Oni uczą się angielskiego od trzech lat."],
    ...
    ["She has worked here ... five years.", "for", "since", "ago", "now", "Она работает здесь пять лет.", "Вона працює тут вже п’ять років.", "Ona pracuje tutaj od pięciu lat."],
    ...
    ["She has been living in London ... five years.", "for", "since", "ago", "lately", "Она живет в Лондоне пять лет.", "Вона живе в Лондоні вже п’ять років.", "Ona mieszka w Londynie od pięciu lat."],
    ...
    ["I have been waiting ... an hour.", "for", "since", "ago", "currently", "Я жду уже час.", "Я чекаю вже годину.", "Czekam już godzinę."],
