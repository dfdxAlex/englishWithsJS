...
export function extendAnalogZeroAndOne(array, strOld, strNew)
{
    return array.filter(el => el[0].toLowerCase().includes(strOld) && el[1].toLowerCase().includes(strOld)
          ).map((el) => {
