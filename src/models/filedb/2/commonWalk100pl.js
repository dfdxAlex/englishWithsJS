export const commonWalk100pl = [
    ['airport', 'аэропорт', 'вокзал', 'станция', 'платформа', '', '', ''],
    ['hotel', 'гостиница', 'ресторан', 'хостел', 'мотель', '', '', ''],
    ['hotel', 'отель', 'ресторан', 'хостел', 'мотель', '', '', ''],
    ...
    ['travel', 'путешествовать', 'поездка', 'прогулка', 'перемещение', '', '', ''],
    ...
    ['destination', 'место назначения', 'пункт пропуска', 'цель', 'место отдыха', '', '', ''],
    ...
    ['cab', 'такси', 'кабинет', 'автомобиль', 'автобус', '', '', ''],
    ...
    ['travel', 'путешествие', 'поездка', 'прогулка', 'путеводитель', '', '', ''],
    ...
    ['ride', 'поездка', 'аттракцион', 'рейд', 'прогулка', '', '', ''],
