export const commonFood100 = [
    ...
    ['plate', 'тарелка', 'чашка', 'прибор', 'бокал', 'тарелка', 'тарілка', 'talerz'],
    ...
    ['flavor', 'вкус', 'салат', 'текстура', 'внешний вид', 'вкус', 'смак', 'smak'],
    ['flavor', 'аромат', 'салат', 'текстура', 'внешний вид', 'аромат', 'смак', 'smak'],
    ...
    ['butter', 'масло', 'маргарин', 'вода', 'молоко', 'масло', 'масло', 'masło'],
    ['cheese', 'сыр', 'творог', 'масло', 'йогурт', 'сыр', 'сир', 'ser'],
    ['dressing', 'соус', 'вкус', 'ингредиент', 'масло', 'соус', 'заправка', 'sos'],
    ['dressing', 'заправка', 'вкус', 'ингредиент', 'масло', 'заправка', 'заправка', 'sos'],
    ...
    ['scone', 'булочка', 'пирог', 'печенье', 'яблочный пирог', 'булочка', 'булочка', 'bułeczka'],
    ['scone', 'лепешка', 'пирог', 'печенье', 'яблочный пирог', 'лепешка', 'коржик', 'ciasto'],
    ['scones', 'булочки', 'печенье', 'лепешка', 'булочка', 'булочки', 'булочки', 'bułeczka'],
    ['soup', 'суп', 'салат', 'закуска', 'десерт', 'суп', 'суп', 'zupa'],
    ...
    ['cupcake', 'пироженное', 'пирог', 'печенье', 'блин', 'кекс', 'кекс', 'babeczka'],
    ...
    commonFood100.nameLeson = "Food 100";
