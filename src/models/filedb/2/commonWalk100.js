export const commonWalk100 = [
    ...
    ['guide', 'гид', 'дорога', 'экскурсия', 'инструктор', '', '', ''],
    ['guide', 'проводник', 'переправа', 'курс', 'инструктор', '', '', ''],
    ['guide', 'экскурсовод', 'курс', 'дорога', 'инструктор', '', '', ''],
    ...
    ['travel', 'путешествовать', 'бегать', 'летать', 'ходить', '', '', ''],
    ['travel', 'перемещение', 'хотьба', 'плавание', 'водить', '', '', ''],
    ['travel', 'путешествие', 'плавать', 'дышать', 'смеяться', '', '', ''],
    ...
    ['cab', 'такси', 'таксист', 'автомобиль', 'служба такси', '', '', ''],
    ['cab', 'кабина грузовика', 'таксист', 'автомобиль', 'служба такси', '', '', ''],
    ['cab company', 'компания такси', 'таксист', 'автомобиль', 'служба такси', '', '', ''],
    ['cab service', 'служба такси', 'таксист', 'автомобиль', 'компания такси', '', '', ''],
    ['taxi service', 'служба такси', 'таксист', 'автомобиль', 'компания такси', '', '', ''],
    ...
    ['viewpoint', 'обзорная площадка', 'разрешение', 'панорама', 'отпуск', '', '', ''],
    ['viewpoint', 'точка обзора', 'разрешение', 'панорама', 'отпуск', '', '', ''],
    ['visa', 'виза', 'разрешение', 'документ', 'паспорт', '', '', ''],
    ['waterfall', 'водопад', 'поток', 'ручей', 'река', '', '', ''],
