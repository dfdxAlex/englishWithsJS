...
import { searchBlockForTag } from '../../../services/searchBlockForTag.js';

export function returnHeaderHelpForLanguage(id)
{
    let str = returnStringHelpForLanguage(id);

    let strToArray = str.split('\n');

    let strRez = searchBlockForTag(strToArray, "h2");

    strRez = ThouryH2('start', 1) + strRez + ThouryH2();
